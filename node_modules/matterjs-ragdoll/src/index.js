...
export function createRagdoll(scale) {
	...
	let lowerLeg1 = Bodies.rectangle(0, 300*scale, 30*scale, 90*scale)
	let lowerLeg2 = Bodies.rectangle(60*scale, 300*scale, 30*scale, 90*scale)
	let upperLeg1 = Bodies.rectangle(0, 150*scale, 30*scale, 90*scale)
	let upperLeg2 = Bodies.rectangle(60*scale, 250*scale, 30*scale, 90*scale)
	...
	let upperleg1_to_torso = Constraint.create({
		bodyA: upperLeg1,
		bodyB: torso,
		pointA: { x: 0*scale, y: -30*scale },
		pointB: { x: -10*scale, y: 50*scale },
		length: 1*scale,
		render: renderProps
	})
